  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const formWithPhotos = {
        ...form,
        photos: uploadedPhotoUrls.length
      ...
      await emailjs.send(
        SERVICE_ID,
        templateId,
        formWithPhotos as Record<string, string>,
        PUBLIC_KEY
      );
...
const uploadPhotos = async () => {
  ...
  try {
    ...
    for (const photo of photos) {
      ...
      data.append("upload_preset", "zp_customer_photos");
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Upload photos of your windows, shades, hardware, or installation area.
                </p>

                <label className="inline-block cursor-pointer border border-black px-5 py-3 text-xs tracking-widest uppercase hover:bg-black hover:text-white transition-colors">
                  Upload Photos
                  <input
                    type="file"
                    accept="image/*"
